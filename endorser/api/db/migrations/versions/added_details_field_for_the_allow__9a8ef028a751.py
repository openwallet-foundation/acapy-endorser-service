...
def upgrade():
    ...
    op.add_column('allowedcredentialdefinition', sa.Column('details', sa.String(), nullable=True))
    op.add_column('allowedpublicdid', sa.Column('details', sa.String(), nullable=True))
    op.add_column('allowedschema', sa.Column('details', sa.String(), nullable=True))
